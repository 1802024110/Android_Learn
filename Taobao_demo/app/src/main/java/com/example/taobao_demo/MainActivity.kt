...
class MainActivity : AppCompatActivity(){
    ...
    private val list1 = ArrayList<HomeCenterTop>().apply {
        ...
        add(HomeCenterTop(R.drawable.dongaogongyi,"东奥公益",R.drawable.xianyu,"闲鱼"))
        add(HomeCenterTop(R.drawable.taopiaopiao,"淘票票",R.drawable.tuhuoxianshi,"土货鲜食"))
        add(HomeCenterTop(R.drawable.tianmaohaofang,"天猫好房",R.drawable.tianmaoqice,"天猫汽车"))
    }
    private val list2 = ArrayList<Goods>().apply {
        for(i in 1..7){
            add(Goods(R.mipmap.goods1,"商品$i","￥2302"))
        }
    }
